...
<?php include('inc/admin-navigation.php'); ?>
    ...
    <?php
			 ...
			 if(isset($_POST['submit']))
			  ...
			  $path=$ename."-".$filename;
			  $insert=mysql_query("INSERT INTO events(ename, eimage, edate, eloc, edesc) VALUES ('$ename','$path','$edate','$eloc','$edesc')");
   		...
   		<form action="" method="post" name="validate" enctype="multipart/form-data" onSubmit="return validateFileExtension(this.photo)">
    		<table width="80%" align="center" border="0" cellspacing="0" cellpadding="5">
              ...
              <tr>
                ...
                <td><input name="eloc" type="text" id="eloc" /></td>
              </tr>
              <tr>
                <td>Event Description</td>
                <td><textarea name="edesc" cols="50" rows="10" id="edesc" > </textarea></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
