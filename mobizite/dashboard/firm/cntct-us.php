	...
	<div class="row">
      ...
      <fieldset>
        ...
        <div class="form-group">
          ...
          <div class="col-lg-10">
            <input class="form-control" id="inputName" placeholder="Name" required type="text">
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <label for="inputNum" class="col-lg-2 control-label">Contact Number</label>
          <div class="col-lg-10">
            <input class="form-control" id="inputNum" placeholder="Contact Number" type="number">
            
          </div>
        </div>
        <div class="form-group">
          <label for="inputSub" class="col-lg-2 control-label">Subject</label>
          <div class="col-lg-10">
            <input class="form-control" id="inputSub" placeholder="Subject" required type="text">
          </div>
        </div>
        <div class="form-group">
    	...
    	<div class="col-lg-3  link">
        	<h3>Address</h3>
        	<address style="margin-top:20px;"><b>Mobizite Pvt. Ltd.</b><br>
                15th Cross, 14th Main,Sector 4,<br>
                HSR Layout.<br>
                Bangalore<br>
				Pincode: 560102<br>
				Contact Number: +91-XXXXXXXXXX<br>
				Email: info@mobizite.com
			</address>
        </div>
