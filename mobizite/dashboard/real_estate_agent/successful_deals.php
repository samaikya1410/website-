...
$insert = mysql_query("INSERT INTO redeals(prop_name,prop_price,prop_image,prop_desc,prop_details) 
VALUES  ('$prop_name','$prop_price','$path','$prop_desc','$prop_details' ) ");


 if($insert){
			 echo "<div align='center'>Successfully Uploaded</div>";
				 move_uploaded_file($prop_imagetmp,"upload_images_deals/$path");	
		 }else
		 {
			 echo 'not updated';
		 }
...
<ul class="nav nav-pills nav-justified">
  ...
  <li class="active"><a href="successful_deals.php">Successful Deals</a></li>
</ul>
</div>
<div class="col-lg-12"><hr></div>
<!-- Nav tabs -->
<ul class="nav nav-tabs" role="tablist">
  <li class="active"><a href="#successful_deals" role="tab" data-toggle="tab">Successful Deals</a></li>
</ul>
...
<div class="tab-content">
  <div class="tab-pane active" id="client_details">
  			<form method="post" enctype="multipart/form-data" class="form-horizontal">
                <div class="form-group">
                  ...
                  <div class="col-sm-10 col-lg-9">
                    <input name="property_name" type="text" class="form-control" id="property_name" placeholder="" required>
                  </div>
                </div>
                <div class="form-group">
                  <label for="property_price" class="col-sm-2  col-lg-3 control-label">Property Price*</label>
                  <div class="col-sm-10 col-lg-9">
                    <input type="text" name="property_price" class="form-control" id="property_price" placeholder="" required>
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10 col-lg-9">
                    <textarea type="text" name="property_details" class="form-control" id="property_details" placeholder="" required></textarea>
                  </div>
                </div>
           ...
           <!--     <div class="form-group">
                ...
                <div class="form-group">
    			<div class="col-sm-offset-2 col-sm-10">
      			<button type="submit" name="s_deals" class="btn btn-default">Submit</button>  
    			</div>
 				</div>
              </form>
  </div>
